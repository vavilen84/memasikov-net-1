...
(function ($) {
    ...
    var i18n = {
        ...
        addTextbox: "Добавить поле",
        advancedSettings: "Расширенные настройки",
        toolbox: "Рисовать",

        optionCapitalLetters: "Использовать только заглавные буквы",
        optionDragResize: "Позволить перетескивать и менять размер полей",
        optionDrawingAboveText: "Показать нарисованный текст сверху",

        drawingStart: "Начать",
        drawingStop: "Стоп",
        drawingErase: "Стереть",
    };
    ...
    var MemeGenerator = function (element, options) {
        ...
        this.ui = {
            createControls: function () {
                ...
                var addTextboxButton = $('<a href="#" class="mg-add-textbox btn btn-primary btn-block">' + i18n.addTextbox + '</a>').appendTo(controls);
            ...
            createPositionHelper: function (box) {
                ...
                helper.css({
                    left: box.attr("data-x") * MG.scale,
                    top: box.attr("data-y") * MG.scale,
                    width: box.attr("data-width") * MG.scale,
                    height: box.attr("data-height") * MG.scale
                });
